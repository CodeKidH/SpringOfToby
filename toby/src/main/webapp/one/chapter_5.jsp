...
<h2 style="color:#FCF9F9">4.separate Method - Use a Mockito Framework</h2>
<h3 style="color:#FCF9F9"># changed : UserServiceTest</h3>
<a class="more" onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'[User]':'[User]';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';" href="javascript:void(0);" onfocus='blur()'>user</a><div style="DISPLAY: none">package toby;
<pre style="color:#A7B32A">
<font size="4">
...
<h2 style="color:#FCF9F9">5.separate Method - Use a Dynamic Proxy</h2>
<h3 style="color:#FCF9F9"># use a Dynamic proxy to apply transaction</h3>
<h3 style="color:#FCF9F9"># changed : UserServiceTest, TransactionHandler</h3>
<a class="more" onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'[User]':'[User]';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';" href="javascript:void(0);" onfocus='blur()'>user</a><div style="DISPLAY: none">package toby;
<pre style="color:#A7B32A">
<font size="4">
package toby;
...
<a class="more" onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'[TransactionHandler]':'[TransactionHandler]';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';" href="javascript:void(0);" onfocus='blur()'>TransactionHandler</a><div style="DISPLAY: none">
<pre style="color:#A7B32A">
<font size="4">
package toby;
...
<h2 style="color:#FCF9F9">6.Transaction Proxy Factory bean</h2>
<h3 style="color:#FCF9F9"># changed : UserServiceTest, applicationContext.xml, TxProxyFactoryBean</h3>
<a class="more" onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'[User]':'[User]';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';" href="javascript:void(0);" onfocus='blur()'>user</a><div style="DISPLAY: none">package toby;
<pre style="color:#A7B32A">
<font size="4">
package toby;
...
<a class="more" onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'[TxProxyFactoryBean]':'[TxProxyFactoryBean]';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';" href="javascript:void(0);" onfocus='blur()'>TxProxyFactoryBean</a><div style="DISPLAY: none">
<pre style="color:#A7B32A">
<font size="4">
package toby;
